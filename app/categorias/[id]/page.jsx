...
const obtenerItemTipo = async(tipo, elementoId) => {
  ...
  return data.categoria[0]
}

const CategoriaPage = async({ params }) => {

  const categoria = await obtenerItemTipo('categorias', params.id)

  const productos = await categoria.productos
